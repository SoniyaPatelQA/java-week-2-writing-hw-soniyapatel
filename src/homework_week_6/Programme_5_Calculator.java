...
public class Programme_5_Calculator {
    ...
    public static void main(String[] args) {
        ...
        Programme_5_Calculator programme5Calculator = new Programme_5_Calculator();
        programme5Calculator.multiplication(a, b);

        int divResult = programme5Calculator.division(a, b);
